...
<div class="promo"><a href="#"><img src="images/yell-logo-whitespace.svg"></a></div>
	...
	<div class="main">
		...
		<section class="showcase">
			<div class="grid">
				<div class="col-1-1 txtc">
					<h2>Over 50,000 UK business trust their website to hibu*</h2>
			...
			<div class="grid">
				<div class="col-1-1 txtc">
					<p>
						Compatible on all kinds of digital device.
						<!-- laptop SVG icon -->	
	...
	<section class="steps">
		<div class="grid">
			<div class="col-1-1">
				<h2>Partner with us to develop the perfect website for you</h2>
			...
			<div class="col-1-4">
				...
				<p>A profesionaly designed bespoke website from only £499.</p>
			</div>
